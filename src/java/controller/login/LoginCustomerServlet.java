...
public class LoginCustomerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String custName = request.getParameter("txtname").trim();
            String phone = request.getParameter("txtphone").trim();

            CustomerDAO d = new CustomerDAO();
            Customer c = d.checkLogin(custName, phone);
            ...
            if (c == null) {
                ...
                s.setAttribute("custID", c.getCustID());
                s.setAttribute("customer", c);
                request.getRequestDispatcher("giang/customerDashBoard.jsp").forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session == null || session.getAttribute("customer") == null) {
            ...
            response.sendRedirect("giang/customerDashBoard.jsp");
        }
